  ...
  return (
    <div>
      <div className="relative grid grid-cols-1 gap-x-14 md:grid-cols-2">
        <button
          type="button"
          className="absolute -left-1.5 -top-1 flex items-center justify-center p-1.5 text-gray-400 hover:text-gray-500 dark:text-gray-200"
        >
        ...
        <button
          type="button"
          className="absolute -right-1.5 -top-1 flex items-center justify-center p-1.5 text-gray-400 hover:text-gray-500 dark:text-gray-200"
        >
      ...
      <section className="mt-12">
        ...
        <ol className="mt-2 divide-y divide-gray-200 text-sm leading-6 text-gray-500 dark:text-gray-200">
          <li className="py-4 sm:flex">
            <time dateTime="2022-01-17" className="w-28 flex-none">
              Miércoles, Julio 12
            </time>
            <p className="mt-2 flex-auto sm:mt-0">
              Nada para el día de hoy
            </p>
          </li>
          <li className="py-4 sm:flex">
            ...
            <p className="mt-2 flex-auto font-semibold text-gray-900 dark:text-white sm:mt-0">
              Algún pendiente
            </p>
          ...
          <li className="py-4 sm:flex">
            ...
            <p className="flex-none sm:ml-6">Todo el día</p>
          </li>
          <li className="py-4 sm:flex">
