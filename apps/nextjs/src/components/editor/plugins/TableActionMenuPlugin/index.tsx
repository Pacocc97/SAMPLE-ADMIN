...
function TableActionMenu({
  ...
  useEffect(() => {
    ...
    if (
      ...
      dropDownElement.style.left = `${leftPosition + window.pageXOffset / 2}px`; //REVISAR ESTO
      ...
      dropDownElement.style.top = `${topPosition + +window.pageYOffset / 20}px`; //REVISAR ESTO
    }
  ...
  return createPortal(
    ...
    >
      ...
      >
        <span className="text">Color de fondo</span>
      </button> */}
      <hr />
      <button
        type="button"
      ...
      >
        <span className="text">Borrar columna</span>
      </button>
      <button
        type="button"
        className="item"
      ...
      >
        <span className="text">Borrar fila</span>
      </button>
      <button
        type="button"
        className="item"
      ...
      >
        <span className="text">Borrar tabla</span>
      </button>
      <hr />
      <button
        type="button"
...
function TableCellActionMenuContainer({
  ...
  return (
    <div
      // className={styles["table-cell-action-button-container"]}
    ...
    >
      {tableCellNode != null && (
        <>
          <button
            type="button"
            // className={styles["table-cell-action-button chevron-down"]}
